...
<html>
	<head>
		<title>STONX - Noob Account</title>
		<meta charset="utf-8" />
				...
				<div class="wrapper style1">
					...
					<div class="container">
						<article id="main" class="special">
							<header>
								<h2><a href="#">Noob Account</a></h2>
								<p>
									Mess around to learn the ins and outs of stonk trading in our simulated environment.
							</header>
							...
							<section>
								...
								<p>
								Don't worry about risking real money on stonks. Perfect for new traders who want to learn how to use the platform and how to trade.
							</p>
							</section>
						</article>
						<hr />
