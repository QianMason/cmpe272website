...
<html>
	<head>
		<title>STONX - Managed Portfolio Plus</title>
		<meta charset="utf-8" />
				...
				<div class="wrapper style1">
					...
					<div class="container">
						<article id="main" class="special">
							<header>
								<h2><a href="#">Managed Portfolio Plus</a></h2>
								<p>
									Have our experts do the work for you.
							</header>
							...
							<section>
								...
								<p>
								Sometimes we know you want to work with our experts more closely. With the plus account, you'll enjoy weekly reports, direct communication with the managing partner, and a personal invitation to our annual investor meeting.
							</p>
							</section>
						</article>
						<hr />
