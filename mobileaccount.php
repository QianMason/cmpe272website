...
<html>
	<head>
		<title>STONX - Mobile Account</title>
		<meta charset="utf-8" />
				...
				<div class="wrapper style1">
					...
					<div class="container">
						<article id="main" class="special">
							<header>
								<h2><a href="#">Mobile Account</a></h2>
								<p>
									Fast paced trading for experienced traders.
							</header>
							...
							<section>
								...
								<p>
								Trade directly on our mobile platform and on the go without the bloat of the main product.
							</p>
							</section>
						</article>
						<hr />
