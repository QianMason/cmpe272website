...
<html>
	<head>
		<title>STONX - Regular Account</title>
		<meta charset="utf-8" />
				...
				<div class="wrapper style1">
					...
					<div class="container">
						<article id="main" class="special">
							<header>
								<h2><a href="#">Regular Account</a></h2>
								<p>
									Standard access account providing trading capabilities on hour platform during hours.
								</p>
							</header>
							...
							<section>
								...
								<p>
								A regular stonk trading account is our basic account for all prospective stonk trader. It provides access to our trading platform and allows you to make volume trades daily during out trading hours. A weekly newsletter from our strategy analysts will be provided offering general advice and trends to all account holders.
							</p>
							</section>
						</article>
						<hr />
