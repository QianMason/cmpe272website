...
<html>
	<head>
		<title>STONX - Retirement Account</title>
		<meta charset="utf-8" />
				...
				<div class="wrapper style1">
					...
					<div class="container">
						<article id="main" class="special">
							<header>
								<h2><a href="#">Retirement Account</a></h2>
								<p>
									Enjoy your retirement by opening a trading account specifically for retirement funds.
							</header>
							...
							<section>
								...
								<p>
								Access to retirement fund specific newsletters and investment strategies as well as comprehensive trading capabilities to make sure you are set for your retirement.
							</p>
							</section>
						</article>
						<hr />
