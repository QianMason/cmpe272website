...
<html>
	<head>
		<title>STONX - Regular Account Plus</title>
		<meta charset="utf-8" />
				...
				<div class="wrapper style1">
					...
					<div class="container">
						<article id="main" class="special">
							<header>
								<h2><a href="#">Regular Account Plus</a></h2>
								<p>
									Standard access account with extra analytical assistance.
							</header>
							...
							<section>
								...
								<p>
								Get extra information in the form weekly newsletters from our top analysts and an virtual invitation to our annual investor meeting.
							</p>
							</section>
						</article>
						<hr />
