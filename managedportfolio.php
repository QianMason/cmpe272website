...
<html>
	<head>
		<title>STONX - Managed Portfolio</title>
		<meta charset="utf-8" />
				...
				<div class="wrapper style1">
					...
					<div class="container">
						<article id="main" class="special">
							<header>
								<h2><a href="#">Managed Portfolio</a></h2>
								<p>
							...
							<section>
								...
								<p>
								Let our experts make the decisions for you so you don't have to worry. Includes monthly reports from the manager assigned to your portfolio on earnings and decision making process.
							</p>
							</section>
						</article>
						<hr />
